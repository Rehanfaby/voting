...
return [
    ...
    'ambassador-point' => [
        ...
        'intro' => 'Ambassadors grade contestants similarly to judges. Use Awaiting → Grade → Listing.',
        'steps' => [
            'Open Awaiting Candidate to see who still needs an ambassador score.',
            'Grade Candidate — choose Ambassador (or yourself) and the contestant.',
            'Enter points for each criterion and save.',
            'Use Grade Listing to review previous ambassador scores.',
        ],
        'tips' => [
            'Ambassador scores are separate from judge scores.',
            'Combined ranking appears under Grading → Contestant Grading.',
        ],
        'shots' => [
