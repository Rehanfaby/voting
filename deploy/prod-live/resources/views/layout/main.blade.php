...
<head>
    ...
    <link rel="stylesheet" href="<?php echo asset('public/css/admin-modern.css') ?>?v=20260630-navy" type="text/css" id="admin-modern-style">
</head>
        ...
        <div class="main-menu">
            <ul id="side-main-menu" class="side-menu list-unstyled">
                ...
                @if($index_employee_active || in_array('qualified_candidate', $all_permission) || in_array('contestant_ranking', $all_permission))
                    <li><a href="#contestants" aria-expanded="false" data-toggle="collapse"> <i class="fa fa-microphone"></i><span>{{trans('file.Contestants')}}</span></a>
...
<script type="text/javascript">
    ...
    (function () {
        function buildSectionTabs() {
            ...
            var groups = document.querySelectorAll('nav.side-navbar .side-menu ul.collapse, nav.side-navbar .side-menu ul.list-unstyled');
