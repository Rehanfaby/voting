                                            ...
                                            <table id="myTable" class="table table-hover order-list">
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                        ...
                                                        <td>
                                                            <input type="hidden" class="booking_method" name="booking_method[]" value="{{ $product_sale->booking_method }}"  />
                                                            @if($product_sale->booking_method == 0)
                                                                <span class="badge badge-primary">Hourly</span>
                                                            @elseif($product_sale->booking_method == 1)
                                                                <span class="badge badge-success">Daily</span>
                                                            @elseif($product_sale->booking_method == 2)
                                                        ...
                                                        <td class="duration"><input type="datetime-local" name="start[]" class="start form-control" value="{{ $product_sale->start }}" required><input type="datetime-local" name="end[]"  value="{{ $product_sale->end }}" class="end form-control" onchange="durationChange(this, '{{$product_sale->product_id}}')" required></td>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <textarea rows="5" class="form-control" name="booking_note" >{{ $lims_sale_data->booking_note }}</textarea>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            if (flag) {
                ...
                cols += '<td><select class="form-control booking_method" name="booking_method[]" onchange="durationChange(this, '+ data[9] +')"  required><option value="">--choose--</option><option value="0">Hourly</option><option value="1">Daily</option><option value="2">Monthly</option></select></td>';
                ...
                cols += '<td class="duration"><input type="datetime-local" name="start[]" class="start form-control" onchange="durationChange(this, '+ data[9] +')" required><input type="datetime-local" name="end[]" class="end form-control" onchange="durationChange(this, '+ data[9] +')" required></td>';
