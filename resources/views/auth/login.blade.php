  ...
  <head>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .auth-card {
            background: #ffffff;
            border: 1px solid rgba(226, 86, 42, .10);
            border-radius: 24px;
            box-shadow: 0 24px 70px rgba(146, 64, 14, .18);
            overflow: hidden;
        }
        .auth-card__head {
            position: relative;
            ...
            background:
                radial-gradient(120% 120% at 50% 0%, rgba(240,169,59,.18), transparent 65%);
        }
        ...
        .auth-logo {
            ...
            border-radius: 22px;
            background: linear-gradient(135deg, rgba(240,169,59,.12), rgba(226,86,42,.10));
        ...
        .field input:focus {
            ...
            box-shadow: 0 0 0 3px rgba(240,169,59,.22);
            background: #fffdf9;
        }
        .field .toggle-pass {
