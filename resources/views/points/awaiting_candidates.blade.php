        ...
        <div class="mg-awaiting__hero">
            <div>
                ...
                <p class="mg-awaiting__sub">
                    @if(!empty($adminView))
                        All approved contestants. Tap a card to grade as a judge (max 100).
                    @else
                        Contestants you have not graded yet. Tap a card to score (max 100).
                    @endif
                </p>
            </div>
        ...
        @else
            <div class="mg-awaiting__grid" id="mg-awaiting-grid">
                @foreach($awaiting->sortBy('name') as $candidate)
                    @php
                        $href = route('points.create', ['candidate_id' => $candidate->id]);
                    ...
                    <a class="mg-awaiting-card" href="{{ $href }}" data-name="{{ strtolower($candidate->name) }}">
                        ...
                        <div class="mg-awaiting-card__body">
                            ...
                            <p class="mg-awaiting-card__hint">Tap to grade · max 100 points</p>
                        </div>
...
<script type="text/javascript">
    ...
    $("ul#point #point-awaiting-list").addClass("active");
