                            ...
                            <li><a href="#letter" aria-expanded="false" data-toggle="collapse"> <i class="fa fa-newspaper-o"></i><span>{{trans('file.Letters')}}</span></a>
                                <ul id="letter" class="collapse list-unstyled ">
                                    ...
                                    @endif
                                        ...
                                        ?>
                                    @if($index_permission_letter_active)
                                        <li id="letter-index-menu"><a href="{{route('letter.all')}}">Letter Listing</a></li>
                                    @endif

                                    @if($create_permission_letter_active)
                                        <li id="letter-create-menu"><a href="{{route('letter.create')}}">Letter Create</a></li>
                                    @endif
                                        <?php
                                    ...
                                    @if($index_permission_letter_rejected_active)
                                        <li id="letter-rejected-menu"><a href="{{route('letter.index.rejected')}}">Rejected Letters</a></li>
                                    @endif
                                        <?php
                                        ...
                                        ?>
                                    @if($index_permission_letter_active)
                                        <li id="letter-awaiting-menu"><a href="{{route('letter.index')}}">Awaiting Editing</a></li>
                                    @endif
                                        <?php
                                        ...
                                        ?>
                                    @if($index_permission_letter_active)
                                        <li id="letter-edited-menu"><a href="{{route('letter.index.edited')}}">Awaiting Approval</a></li>
                                    @endif
                                        <?php
                                        ...
                                        ?>
                                    @if($index_permission_letter_active)
                                        <li id="letter-approved-menu"><a href="{{route('letter.index.approved')}}">Awaiting Signature</a></li>
                                    @endif
                                        ...
                                        ?>
                                    @if($index_permission_letter_active)
                                    <li id="letter-signed-menu"><a href="{{route('letter.index.signed')}}">Ready To Send</a></li>
                                    @endif
                                        ...
                                        ?>
                                    @if($index_permission_letter_active)
                                        <li id="letter-sent-menu"><a href="{{route('letter.index.sent')}}">Sent Letters</a></li>
                                        <li id="letter-sent-print-menu"><a href="{{route('letter.index.sent.print')}}">Print Letters</a></li>
                                        <li id="letter-sent-download-menu"><a href="{{route('letter.index.sent.download')}}">Download Letters</a></li>
                                    @endif
                                        <?php
