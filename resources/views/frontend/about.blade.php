        ...
        <section class="ms-choose-area pt-125 pb-105">
            <div class="container">
                <div class="row  mb-25 bdFadeUp" style="translate: none; rotate: none; scale: none; opacity: 1; transform: translate(0px, 0px);">
                    ...
                    <div class="col-lg-6">
                        <div class=" mb-40">
                            <h2 class="section__title mb-35 bd-title-anim" style="perspective: 400px;"><div style="display: block; text-align: start; position: relative; translate: none; rotate: none; scale: none; transform-origin: 373px 24px; transform: translate3d(0px, 0px, 0px); opacity: 1;">{{trans('file.Competition Format')}}:</div></h2>
                            <p>
                                {{trans("file.The competition will span over several weeks, featuring multiple rounds designed to test the contestants' musical abilities, creativity, and stage presence. The diverse genres of music, including Afrobeat, Makossa, Bikutsi, and Hip‐hop, among others, will be embraced, ensuring a vibrant and inclusive showcase of Cameroon's musical heritage")}}.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6">
                        <div class=" mb-40">
                            <h2 class="section__title mb-35 bd-title-anim" style="perspective: 400px;"><div style="display: block; text-align: start; position: relative; translate: none; rotate: none; scale: none; transform-origin: 373px 24px; transform: translate3d(0px, 0px, 0px); opacity: 1;">{{trans('file.Grand Finale and Prizes')}}:</div></h2>
                            <p>
                                {{trans("file.The competition will culminate in a spectacular grand finale, where the remaining contestants will showcase their talent and compete for the top honors. The finale will be a grand celebration of music, featuring electrifying performances from captivating stage production, and guest appearances by renowned artists (The Prophetic Minstrel). The winners of Beyond the Talent Show will receive a range of prizes designed to support their musical journeys. These prizes will include , financial Rewards (500,000frs) recording contracts, music production opportunities, performance bookings, mentorship packages, and valuable connections within the music industry. Additionally, the exposure gained through the competition will open doors to new opportunities and propel the winners towards successful music careers")}}.
                            </p>
                        </div>
                    </div>
