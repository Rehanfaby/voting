...
class SaleController extends Controller
{
    ...
    public function genPDFInvoice($id)
    {
        ...
        try{
            ...
            $message = 'Sale notification not sent. Please setup your whatsapp setting.';
        }
...
//        dd($data);
    ...
    public function posSale()
    {
        ...
        if($role->hasPermissionTo('sales-add')){
            ...
            $lims_product_list = Product::select('id', 'name', 'code', 'image')->ActiveFeatured()->whereNull('is_variant')->where('qty', '>', 0)->get();
            if ($role->hasPermissionTo('search_all_products')){
