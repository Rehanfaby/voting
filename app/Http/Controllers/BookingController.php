...
//        return view('pdf.booking_pdf', $data);
        ...
        try{
            ...
            $message = 'Booking notification not sent. Please setup your whatsapp setting.';
        }
...
//                $paying_method = 'Credit Card';
    ...
    public function sendWhatsappMsg($lims_customer_data, $lims_sale_data, $mail_data, $biller, $paying_method, $booking_note, $net_unit_price){
        $general_setting = GeneralSetting::first();

        $msg = '*Subject:* Booking Details for '. $lims_customer_data->name . '\n\n';
        $msg .= '*Order Details:*\n';
        ...
        foreach ($mail_data['products'] as $key => $product) {
            ...
            $msg .= 'Start Date: '. $mail_data['start'][$key] . '\n';
            $msg .= 'End Date: '. $mail_data['end'][$key] . '\n\n';
        }

        $msg .= 'Special Requests: ' . $booking_note . '\n\n';

        $msg .= '*Facility Information:*\n';
        $msg .= 'Facility Name: ' . $biller->name . '\n';
        $msg .= 'Address: ' . $biller->address . '\n';
        $msg .= 'Contact Number: ' . $biller->phone_number . '\n\n';
        ...
        $msg .= 'We are thrilled to host you at '. $general_setting->site_title .'. and assure you that our dedicated staff will go above and beyond to make your stay comfortable and enjoyable. We hope you have a wonderful experience with us.\n';
